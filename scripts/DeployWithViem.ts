...
import { abi, bytecode } from "../artifacts/contracts/EthenaPredictionMarket.sol/EthenaPredictionMarket.json";
...
async function main() {
  ...
  console.log("\nDeploying EthenaPredictionMarket contract");
  ...
  console.log("EthenaPredictionMarket contract deployed to:", receipt.contractAddress);
